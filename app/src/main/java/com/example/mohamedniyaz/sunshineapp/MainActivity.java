 ...
 */
package com.example.mohamedniyaz.sunshineapp;
...
import com.example.mohamedniyaz.sunshineapp.data.SunshinePreferences;
import com.example.mohamedniyaz.sunshineapp.utilities.NetworkUtils;
import com.example.mohamedniyaz.sunshineapp.utilities.OpenWeatherJsonUtils;
...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler, LoaderCallbacks<String[]> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            invalidateData();
            //Here the loadmanager set the loader task when it is refreshed
